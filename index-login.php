				...
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							<p class="subtitle">Unique & Authentic Design</p>
							<h1>Experience Every Angle of Perfection in 3D</h1>
							<div class="hero-btns">
								<a href="shop.html" class="boxed-btn">Available Product</a>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
					<div class="list-box d-flex align-items-center">
						...
						<div class="content">
							<h3>Great Quality 3D Printing</h3>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<p>Copyrights &copy; 2025 - Cyform Studio Sdn Bhd,  All Rights Reserved.<br>
						Developed By - <a href="https://themewagon.com/">Muhd Firdaus</a>
					</p>
				</div>
